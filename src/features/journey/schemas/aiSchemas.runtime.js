...
export const JourneySegmentSchema = z.object({
  ...
  optimizationPreferences: z.object({
    ...
    walkingWeight: z.number().nonnegative(),
    transfersWeight: z.number().nonnegative(),
    comfortWeight: z.number().nonnegative().optional(),
  }).optional(),
  ...
  routingAlternatives: z.array(z.object({
    ...
    comfortScore: z.number().nonnegative().optional(),
