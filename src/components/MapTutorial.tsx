...
const tutorialSteps = [
  ...
  },
  {
    ...
    description: 'Community safety information and reporting guidance',
    icon: MessageSquare,
    content: [
      '🧭 Review available safety guidance',
      '📱 Consult trusted community resources',
      '📢 Check local news directly',
      '⚠️ No verified live incident feed',
      '🔔 Recheck official sources before travel',
    ],
    color: 'bg-indigo-500',
  },
];
