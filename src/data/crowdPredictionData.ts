...
export const crowdPredictionDatabase: DestinationCrowdProfile[] = [
  {
    ...
    monthlyData: {
      January: {
        ...
        crowdLevel: 'High',
        score: 85,
        majorEvents: ['New Year', 'Snow Season'],
      ...
      December: {
        ...
        crowdLevel: 'Critical',
        score: 92,
        majorEvents: ['Christmas', 'New Year'],
        weatherImpact: 'Positive',
      },
    },
  },
  {
    ...
    monthlyData: {
      January: {
        ...
        crowdLevel: 'Critical',
        score: 95,
        majorEvents: ['New Year Aftermath', 'Sunburn'],
        weatherImpact: 'Positive',
      },
      February: {
        avgFootfall: 18000,
      ...
      August: {
        ...
        crowdLevel: 'Moderate',
        score: 45,
        majorEvents: ['Independence Day Long Weekend'],
        weatherImpact: 'Neutral',
      },
      ...
      December: {
        ...
        crowdLevel: 'Critical',
        score: 99,
        majorEvents: ['Christmas', 'New Year', 'Sunburn'],
        weatherImpact: 'Positive',
      },
    },
  },
  {
    ...
    monthlyData: {
      January: {
        ...
        crowdLevel: 'Critical',
        score: 90,
        majorEvents: ['Literature Festival'],
        weatherImpact: 'Positive',
      },
  ...
  },
  {
    ...
    monthlyData: {
      ...
      May: {
        ...
        crowdLevel: 'Critical',
        score: 98,
        majorEvents: ['Flower Show', 'Summer Festival'],
        weatherImpact: 'Neutral',
      },
  ...
  },
  {
    ...
    monthlyData: {
      ...
      August: {
        ...
        crowdLevel: 'Moderate',
        score: 45,
        majorEvents: ['Nehru Trophy (Nearby)'],
        weatherImpact: 'Negative',
      },
      September: {
        avgFootfall: 6000,
